...
<body>
<p align= "center" style="color:#0000ff"> ELIMINAR PRODUCTOS </p>
	<form action="eliminarProductoApi.jsp"  method= POST>
	<table>
	
		<tr>
		<td><label>Codigo del Producto :</label></td>
		<td><input type = "text" name = "codigo_producto" class = "form-control"  placeholder = "Digite el codigo del producto" required> </td> 
		</tr>
